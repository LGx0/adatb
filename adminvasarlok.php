...
<tr><th>Név</th><th>Email</th><th>Regisztrált</th><th>Számlaszám</th><th>Egyenleg</th><th>Irszám</th><th>Város</th><th>Utca</th><th>Házszám</th></tr>
<form method="post" action="felhasznalomodosit.php">
<?php
	while ($row = oci_fetch_array($select, OCI_ASSOC+OCI_RETURN_NULLS)) {
			echo "<tr>";
					
					echo "<td><input type=\"text\" name=\"nev\" size = \"10\"  value=\"".$row['NEV'] ."\"</td>";
					echo "<td><input type=\"text\" name=\"email\" size = \"20\"  value=\"".$row['EMAIL'] ."\"</td>";
			...
			/*		echo "<td>".$row['NEV'] ."</td>";
					...
					echo "<td><input type='submit' value='Módosít' name='modosit'/></td>";
...
<form method="post" action="regel.php" >
	<fieldset id="f1"> 
		<legend><b>Vásárló felvétele</b></legend>
